...
void man(char * name)
{
    ...
    {
        printf("Description : Used to list all information of files file.\n");
        printf("Usage : ls\n");
    }
    ...
    {
        printf("Description : Used to display information of file.\n");
        printf("Usage : stat File_Descriptor Permission\n");
    }
    ...
    else if(strcmp(name,"lseek") == 0)
    {
        ...
        printf("Usage : lseek File_Name ChaneInOffset StartPoint \n");
    }
...
void DisplayHelp()
{
    ...
    printf("truncate : To reamove all data from file\n");
...
int rm_File(char * name)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->LinkCount == 0)
    {
        ...
        //free(    if(UFDTArr[fd].ptrfiletable->ptrinode->Buffer);
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            ...
            else if(strcmp(command[0],"read") == 0)
            {
                ...
                if(ptr == NULL)
                {
                    printf("ERRPR : Memory allocation failure\n");
                    continue;
                }
        ...
        else if(count == 4 )
        {
            if(strcmp(command[0],"lseek")== 0)
            {
                ...
                if(ret == -1)
                {
                    printf("\nERROR : Unable to perform lcd seek\n");
                }
            }
            else
            {
